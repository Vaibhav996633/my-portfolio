      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mt-16">
          ...
          >
            ...
            >
              <motion.h3 variants={FADE_IN_UP} className="text-2xl font-bold text-neon-purple mb-4">
                Who I Am
              </motion.h3>
              ...
              >
                I'm an MCA student at Indira College of Engineering and Management, passionate
                about merging creativity with code. My focus lies in building clean, functional,
                and visually engaging software solutions using Java, React.js, and Spring Boot.
              </motion.p>
              ...
              <motion.p
                ...
                className="text-muted-foreground leading-relaxed mb-6"
              >
                With a strong foundation in both frontend and backend development, I believe in
                creating holistic digital experiences that not only look stunning but also
                perform flawlessly.
              </motion.p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-foreground">
                    <span className="font-semibold text-neon-blue">2023-2025:</span> MCA at Indira
                    College
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-neon-green rounded-full" />
                  <span className="text-foreground">
                    <span className="font-semibold text-neon-blue">2020-2023:</span> BA Economics at
                    Appasaheb Jedhe College
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-neon-green rounded-full" />
                  <span className="text-foreground">
                    <span className="font-semibold text-neon-blue">2024:</span> Multiple
                    certifications in tech skills
                  </span>
                </div>
              </motion.div>
            </motion.div>
