...
export const SKILLS = {
  ...
  'Databases & Tools': [
    { name: 'MySQL', proficiency: 85, icon: '🗄️' },
    { name: 'GitHub', proficiency: 90, icon: '🐙' },
    { name: 'Figma', proficiency: 80, icon: '🎭' },
    { name: 'VS Code', proficiency: 95, icon: '⚙️' },
  ],
  'Soft Skills': [
    { name: 'Problem-Solving', proficiency: 90, icon: '💡' },
    { name: 'Team Collaboration', proficiency: 88, icon: '🤝' },
...
export const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    description: 'Presented research at National Conference on Technological Advancements',
    conference: 'NCTAA Conference 2025',
    type: 'presentation',
  },
  {
    id: 3,
